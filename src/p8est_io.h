...
#define P8EST_MAGIC_NUMBER "p8data"
#define P8EST_NUM_METADATA_BYTES 64
#define P8EST_NUM_ARRAY_METADATA_BYTES 16
/* substract 2 for '\n' at the beginning and end of the array metadata */
#define P8EST_NUM_ARRAY_METADATA_CHARS (P8EST_NUM_ARRAY_METADATA_BYTES - 2)
#define P8EST_BYTE_DIV 16
...
#define P8EST_FILE_CHECK_NULL(errcode, user_msg) {SC_CHECK_MPI_VERBOSE (errcode, user_msg);\
                                            if (errcode != sc_MPI_SUCCESS) {\
                                            return NULL;}}

#define P8EST_FILE_CHECK_VOID(errcode, user_msg) {SC_CHECK_MPI_VERBOSE (errcode, user_msg);\
                                            if (errcode != sc_MPI_SUCCESS) {\
                                            return;}}
 ...
 */
#define P8EST_FILE_CHECK_MPI(errcode, user_msg) {SC_CHECK_MPI_VERBOSE (errcode, user_msg);\
                                                        if (mpiret != sc_MPI_SUCCESS) {\
                                                        goto p8est_read_write_error;}}
 ...
 */
#define P8EST_HANDLE_MPI_ERROR(mpiret,fc,comm) {p8est_read_write_error:\
 ...
 * defined data per quadrant of a certain p8est. Therefore, one user-defined
 ...
 * /ref P8EST_LERRORF- * /ref P8EST_LERRORF, collectively close 
 ...
 *                            p8est_file_open_read.  It keeps track
 ...
 *
 * \param [in]  p8est               A p8est that is only required for the
