...
#endif
{
  ...
  int8_t              rface[2];
#endif
  int8_t              level, type, left_side, right_side,
  ...
  p4est_topidx_t     *ttt = conn->tree_to_tree,
    global_num_trees, nt, t, c, guess_tree;
  ...
  int8_t              perm, corner0, corner1, ne, m, l, dir, side;
