 ...
 * A process can give more quadrants than it owns, if it passes quadrants form
 * other processes.
 *
 ...
 */
int                 p4est_compute_partition_correction (
                                       p4est_gloidx_t *partition,
				       int num_procs,
				       int rank,
 ...
 */
int                 p4est_find_next_nonempty_process (
                                       int rank,
                                       int num_procs,
