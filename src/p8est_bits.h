 ...
 * \param [in] z z Morton indice.
 * \return Returns true if \a (x,y,z) is inside the unit tree.
 */
int                 p8est_quadrant_coord_is_inside_root (p4est_qcoord_t x,
                                                         p4est_qcoord_t y,
                                                         p4est_qcoord_t z);
 ...
 * \return Returns true if \a (x,y,z,level) is valid.
 */
int                 p8est_quadrant_coord_is_valid (p4est_qcoord_t x,
                                                   p4est_qcoord_t y,
                                                   p4est_qcoord_t z,
                                                   int level);
