...
p4est_ghost_topdown (p4est_t * p4est, p4est_connect_type_t btype,
...
p4est_ghost_t      *
p4est_ghost_new_ext (p4est_t * p4est, p4est_connect_type_t btype)
{
  return p4est_ghost_topdown (p4est, btype, P4EST_GHOST_UNBALANCED_ALLOW);
}
