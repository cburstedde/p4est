 ...
 * The function can also determine neighbor trees.
 ...
 * \param [out] tree_contact[9] True if there are neighboring trees in the
 ...
 * \param [in] tree_contact[9]  Flags as computed by p4est_comm_tree_info.
