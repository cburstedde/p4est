...
#ifndef P8EST_LMESH_TRILINEAR_H
#define P8EST_LMESH_TRILINEAR_H
 ...
 */
trilinear_mesh_t   *p8est_trilinear_lmesh_new (p8est_t * p8est,
                                               p8est_lnodes_t * nodes);

/** Frees a trilinear mesh structure.
 */
void                p8est_trilinear_lmesh_destroy (trilinear_mesh_t * mesh);
