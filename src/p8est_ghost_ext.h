...
typedef enum
{
  ...
  P8EST_GHOST_UNBALANCED_FAIL,
  P8EST_GHOST_UNBALANCED_ALLOW
}
p8est_ghost_tolerance_t;

#ifdef P4EST_ENABLE_MPI

/** Data structure that contains temporary mirror information */
typedef struct p8est_ghost_mirror
{
  int                 mpisize, mpirank;
 ...
 */
void                p8est_ghost_mirror_add (p8est_ghost_mirror_t * m,
 ...
 */
int                 p8est_ghost_add_to_buf (sc_array_t * buf,
                                            p4est_topidx_t treeid,
                                            p4est_locidx_t number,
